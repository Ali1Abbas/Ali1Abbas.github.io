<html>
  ...
  <head>
    <title> customer Signup | iRental </title>
  </head>
...
$query = "INSERT into customers(customer_name,customer_username,customer_email,customer_phone,customer_address,customer_password,lng,lat,type) VALUES('" . $customer_name . "','" . $customer_username . "','" . $customer_email . "','" . $customer_phone . "','" . $customer_address ."','" . $customer_password ."','".$lng."','".$lat."','".$type."')";
