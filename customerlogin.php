...
?>
    ...
    <head>
        <title> Customer Login | iRental </title>
    </head>
    ...
    <body background="assets/img/delar.png">
                 <!-- Navigation -->
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        ...
        <div class="container">
            <div class="jumbotron" style="background-image: url(\iRental\assets\img\delar.jpg) ;">
                <h1>Welcome to iRental </span>
                </h1>
                <br>
        ...
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                ...
                <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                            ...
                            <label style="margin-left: 5px;"><a href="Forgetpass.php">Forget password</a></label>
                            <br>
